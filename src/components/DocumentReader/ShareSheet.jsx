...
const ShareSheet = ({ isOpen, onClose, section }) => {
  ...
  const handleShare = async (action) => {
    try {
      ...
      switch(action) {
        ...
        case 'message':
          ...
          if (navigator.share) {
            ...
            setShareStatus({ success: false, message: 'Messaging not available on this device' });
          }
          break;
        ...
        case 'native':
          if (navigator.share) {
            ...
            setShareStatus({ success: false, message: 'Native sharing not available on this device' });
          }
          break;
      ...
      setShareStatus({ success: false, message: error.message || 'Share failed' });
    }
      ...
      >
        ...
        >
          ...
          <div className="px-4 pt-2 pb-4">
            <h3 className="text-lg font-semibold">{section?.title || docContent.title}</h3>
